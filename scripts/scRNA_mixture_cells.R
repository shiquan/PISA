...
sp <- as.data.frame(sp)
sp$total = sp$Human_UY + sp$Mouse_UY
sp = sp[order(sp$total, decreasing = T),]

sp$Species_UMI = "Mix"
sp[sp$Human_UY/sp$total<0.1,]$Species_UMI="Mouse"
sp[sp$Mouse_UY/sp$total<0.1,]$Species_UMI="Human"
